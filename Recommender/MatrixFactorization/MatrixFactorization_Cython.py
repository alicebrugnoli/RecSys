from Recommender.BaseMatrixFactorizationRecommender import BaseMatrixFactorizationRecommender
from Recommender.Incremental_Training_Early_Stopping import Incremental_Training_Early_Stopping
...
class _MatrixFactorization_Cython(BaseMatrixFactorizationRecommender, Incremental_Training_Early_Stopping):
    ...
    def fit(self, epochs=100, batch_size=1000,
        ...
        from Recommender.MatrixFactorization.MatrixFactorization_Cython_Epoch import \

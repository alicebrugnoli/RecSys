...
from Recommender.Recommender_utils import similarityMatrixTopK
...
class SLIM_BPR_Cython(BaseItemSimilarityMatrixRecommender, Incremental_Training_Early_Stopping):
    ...
    def fit(self, epochs=300,
            ...
            symmetric=True,
            random_seed=None,
            lambda_i=0.0, lambda_j=0.0, learning_rate=0.0001, topK=100,
            sgd_mode='adagrad', gamma=0.995, beta_1=0.9, beta_2=0.999,
            **earlystopping_kwargs):

        # Import compiled module
        from Recommender.SLIM.Cython.SLIM_BPR_Cython_Epoch import SLIM_BPR_Cython_Epoch
